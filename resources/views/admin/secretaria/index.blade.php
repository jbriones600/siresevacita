                        ...
                        <tr>
                            ...
                            <td style="text-align: center">
                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                   ...
                                   <a href="{{url('admin/usuarios/'.$usuario->id.'/edit')}}" class="btn btn-success btn btn-sm"><i class="bi bi-pencil"></i></a>
                                   <a href="{{url('admin/usuarios/'.$usuario->id.'/confirm-delete')}}" class="btn btn-danger btn btn-sm"><i class="bi bi-trash3-fill"></i></a>
                                </div>
